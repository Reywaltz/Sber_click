from cmd.additions.additions import auth_required
...
class WorkerHandler:
    ...
    def create_worker(self):
        ...
        try:
            self.worker_storage.insert(new_user)
    ...
    def update_worker(self, id: int):
        ...
        try:
            self.worker_storage.update(updated_user)
        except IntegrityError as e:
